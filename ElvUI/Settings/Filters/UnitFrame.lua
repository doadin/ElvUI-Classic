...
G.unitframe.aurafilters.CCDebuffs = {
	...
	spells = {
	--Druid
	[339] = Defaults(2), --Entangling Roots(Rank 1)
	[1062] = Defaults(2), --Entangling Roots(Rank 2)
	[5195] = Defaults(2), --Entangling Roots(Rank 3)
	[5196] = Defaults(2), --Entangling Roots(Rank 4)
	[9852] = Defaults(2), --Entangling Roots(Rank 5)
	[9853] = Defaults(2), --Entangling Roots(Rank 6)
	[2637] = Defaults(2), --Hibernate(Rank 1)
	[18657] = Defaults(2), --Hibernate(Rank 2)
	[18658] = Defaults(2), --Hibernate(Rank 3)
	--Hunter
	[1499] = Defaults(2), --Freezing Trap(Rank 1)
	[14310] = Defaults(2), --Freezing Trap(Rank 2)
	[14311] = Defaults(2), --Freezing Trap(Rank 3)
	[13809] = Defaults(2), --Frost Trap
	[19503] = Defaults(2), --Scatter Shot
	...
	--Mage
	[118] = Defaults(2), --Polymorph(Rank 1)
	[12824] = Defaults(2), --Polymorph(Rank 2)
	[12825] = Defaults(2), --Polymorph(Rank 3)
	[12826] = Defaults(2), --Polymorph(Rank 4)
	[122] = Defaults(2), --Frost Nova(Rank 1)
	[865] = Defaults(2), --Frost Nova(Rank 2)
	[6131] = Defaults(2), --Frost Nova(Rank 3)
	[10230] = Defaults(2), --Frost Nova(Rank 4)
	--Paladin
	[853] = Defaults(2), --Hammer of Justice(Rank 1)
	[5588] = Defaults(2), --Hammer of Justice(Rank 2)
	[5589] = Defaults(2), --Hammer of Justice(Rank 3)
	[10308] = Defaults(2), --Hammer of Justice(Rank 4)
	[20066] = Defaults(2), --Repentance
	--Priest
	[8122] = Defaults(2), --Psychic Scream(Rank 1)
	[8124] = Defaults(2), --Psychic Scream(Rank 2)
	[10888] = Defaults(2), --Psychic Scream(Rank 3)
	[10890] = Defaults(2), --Psychic Scream(Rank 4)
	[605] = Defaults(2), --Mind Control(Rank 1)
	[10911] = Defaults(2), --Mind Control(Rank 2)
	[10912] = Defaults(2), --Mind Control(Rank 3)
	--Rogue
	[6770] = Defaults(2), --Sap(Rank 1)
	[2070] = Defaults(2), --Sap(Rank 2)
	[11297] = Defaults(2), --Sap(Rank 3)
	[2094] = Defaults(2), --Blind
	--Shaman
	[2484] = Defaults(2), --Earthbind Totem
	--Warlock
	[5782] = Defaults(2), --Fear(Rank 1)
	[6213] = Defaults(2), --Fear(Rank 2)
	[6215] = Defaults(2), --Fear(Rank 3)
	[18223] = Defaults(2), --Curse of Exhaustion
	--Warrior
	[5246] = Defaults(2), --Intimidating Shout
