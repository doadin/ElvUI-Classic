...
G.unitframe.buffwatch = {
	PRIEST = {
		...
		[27581] = UF:AuraWatch_AddSpell(27581, "TOPRIGHT", {0.2, 0.7, 0.2}, true), --Prayer of Spirit (Rank 1)
		...
		[600] = UF:AuraWatch_AddSpell(600, "BOTTOM", {0.00, 0.00, 1.00}), --Power Word: Shield (Rank 3), true
