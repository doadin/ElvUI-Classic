...
L["Lock"] = "Закрепить"
L["LOGIN_MSG"] = ("Добро пожаловать в *ElvUI|r |cff1784d1Classic|r версии *%s|r, наберите /ec для доступа в меню настроек. Если Вам нужна техническая поддержка, посетите наш форум на https://www.tukui.org или присоединяйтесь к серверу Discord: https://discord.gg/xFWcfgE"):gsub('*', COLOR1)
