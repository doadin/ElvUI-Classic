...
L["Lock"] = "Bloquear"
L["LOGIN_MSG"] = ("Bienvenido a *ElvUI|r |cff1784d1Classic|r versión *%s|r, escribe /ec para acceder al menú de configuración del juego. Si necesita ayuda, puede visítenos en https://www.tukui.org o unirse a nuestro Discord: https://discord.gg/xFWcfgE"):gsub('*', COLOR1)
