...
L["Lock"] = "Bloquear"
L["LOGIN_MSG"] = "Bienvenido a %sElvUI|r |cff1784d1Classic|r versión %s%s|r, escribe /ec para acceder al menú de configuración del juego. Si necesita ayuda, puede visítenos en https://www.tukui.org o unirse a nuestro Discord: https://discord.gg/xFWcfgE"
