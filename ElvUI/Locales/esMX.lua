...
L["Bar "] = "Barra "
L["Bars"] = "Barras"
L["Battleground datatexts temporarily hidden, to show type /bgstats"] = "Textos de datos de los campos de batalla temporalmente ocultos, para mostrarlos escribe /bgstats o click derecho en 'C' donde el minimapa."
