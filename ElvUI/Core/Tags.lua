...
E.TagInfo = {
	...
	['name:veryshort:status'] = { category = 'Names', description = "Replaces the name of the unit with 'DEAD' or 'OFFLINE' (limited to 5 letters)" },
	['name:short:status'] = { category = 'Names', description = "Replaces the name of the unit with 'DEAD' or 'OFFLINE' (limited to 10 letters)" },
	['name:medium:status'] = { category = 'Names', description = "Replaces the name of the unit with 'DEAD' or 'OFFLINE' (limited to 15 letters)" },
	['name:long:status'] = { category = 'Names', description = "Replaces the name of the unit with 'DEAD' or 'OFFLINE' (limited to 20 letters)" },
